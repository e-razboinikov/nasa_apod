...
class _$ApodStateTearOff {
  ...
  LoadingApodState loading({required DateTime date}) {
    return LoadingApodState(
      date: date,
    );
  }

  LoadedApodState loaded({required ApodModel apod}) {
...
mixin _$ApodState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApodModel apod) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(ApodModel apod)? loaded,
...
class _$LoadingApodState implements LoadingApodState {
  const _$LoadingApodState({required this.date});
  ...
  @override
  String toString() {
    return 'ApodState.loading(date: $date)';
  }
  ...
  $LoadingApodStateCopyWith<LoadingApodState> get copyWith =>
      _$LoadingApodStateCopyWithImpl<LoadingApodState>(this, _$identity);
...
abstract class LoadedApodState implements ApodState {
  const factory LoadedApodState({required ApodModel apod}) = _$LoadedApodState;
